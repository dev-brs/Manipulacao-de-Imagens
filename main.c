...
int DESENHA(int y1, int y2, int x1, int x2,unsigned char *pPixels,unsigned char *pPixelsAUX,int altura, int largura,int tamanho,unsigned char *pPixels2 )
{
    EQUACAO reta[AUXCIRCULO];
...
int main()
{
    ...
    switch (opc)
    {
        ...
        case 7://inicio do case 7
            printf("Você escolheu achar um objeto, insira as respectivas cores do objeto que você deseja achar");
            printf("Cor do objeto - Primeira Imagem.");
            printf("\nRED: ");
            scanf("%d",&red);
            printf("\nBLUE:");
            scanf("%d",&blue);
            ...
            printf("Cor do objeto - Segunda Imagem.");
            printf("\nRED: ");
            scanf("%d",&red2);
            printf("\nBLUE:");
            scanf("%d",&blue2);
            ...
            DESENHA(y1,y2,x1,x2,pPixels,pPixelsAUX,dados_imagem.altura,dados_imagem.largura,tamanho,pPixels2);
